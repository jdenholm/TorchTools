"""Test calling `DenseNetwork` with different input and output features."""
...
def test_model_with_correct_input_features():
    ...
    model = DenseNetwork(10, 2, hidden_sizes=(5, 5, 5))
    _ = model(rand(2, 10))
...
def test_number_of_output_features_is_correct():
    ...
    model = DenseNetwork(10, 128, hidden_sizes=(5, 5, 5))
